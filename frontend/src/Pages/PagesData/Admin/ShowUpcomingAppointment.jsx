...
const ShowUpcomingAppointment = () => {
    ...
    useEffect(() => {
        console.log("ShowUpcomingAppointment component mounted successfully!");
    ...
    const handleDelete = async (appointmentId) => {
        if (window.confirm('Are you sure you want to delete this upcoming appointment?')) {
            try {
                ...
                alert('Upcoming appointment deleted successfully!');
            } catch (error) {
                console.error("Error deleting upcoming appointment:", error);
    ...
    if (loading) return (
        <div style={{ 
            ...
            <div style={{ marginBottom: '20px' }}>Loading upcoming appointments...</div>
            <div style={{
                width: '40px',
                height: '40px',
  ...
  : 'N/A'}
                        ...
                        <div style={{ 
                            ...
                            <span style={{ 
                                ...
                                📊 Total Upcoming Appointments: <span style={{ color: '#4CAF50' }}>{upcomingAppointments.length}</span>
                            </span>
                        </div>
                    </>
                )}
...
export default ShowUpcomingAppointment;